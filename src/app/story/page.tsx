      ...
      <main className="flex-1 pt-28 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-6xl text-white tracking-tight">
            From Dough to <span className="text-brand-red">Doorstep.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 relative aspect-video rounded-3xl overflow-hidden glass-panel border border-brand-border shadow-2xl">
            <Image
          ...
          <div className="lg:col-span-6 space-y-4">
            <span className="text-xs font-mono font-bold text-brand-orange uppercase">Chapter 01</span>
            <h2 className="font-display font-bold text-3xl text-white">The 72-Hour Cold Fermentation Secret</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 order-2 lg:order-1 space-y-4">
            <span className="text-xs font-mono font-bold text-brand-red uppercase">Chapter 02</span>
            <h2 className="font-display font-bold text-3xl text-white">500°C Blazing Stone Hearth</h2>
            <p className="text-xs sm:text-sm text-brand-muted leading-relaxed">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 relative aspect-video rounded-3xl overflow-hidden glass-panel border border-brand-border shadow-2xl">
            <Image
